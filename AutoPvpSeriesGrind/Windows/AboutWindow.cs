...
public sealed class AboutWindow : Window, IDisposable
{
    ...
    private const string IssuesUrl = "https://github.com/XeldarAlz/FFXIV-AutoPVPSeriesGrind/issues";
    private const string DiscussionsUrl = "https://github.com/XeldarAlz/FFXIV-AutoPVPSeriesGrind/discussions";
    private const string SecurityUrl = "https://github.com/XeldarAlz/FFXIV-AutoPVPSeriesGrind/security/advisories/new";
    ...
    public AboutWindow() : base("Auto PVP Series Grind: About###AutoPvpSeriesGrindAbout")
    {
