...
// A small accent-topped stat card: icon + caption on top, large value on the bottom. Shared by the main
// window's session strip and the run-history lifetime row so the two never drift.
