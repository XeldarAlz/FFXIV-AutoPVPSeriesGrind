...
internal static class CustomStrategySettings
{
    ...
    [
        ...
        new("Team & range",
        [
            new("Engage radius", "Size of the area around the fight used to count who is winning it.",
            ...
            new("Kite distance", "How far each retreat step takes you away from the enemy.",
        ...
        [
            ...
            new("Reposition step", "When enemies target you, how far to step back toward your team in one move.",
