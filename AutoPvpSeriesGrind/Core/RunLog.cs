...
// console instead of digging the [APSG] lines out of dalamud.log. IPC callbacks and file loads log
...
public static class RunLog
{
    ...
    {
        Svc.Log.Warning(exception, $"{ApsgConstants.LogPrefix} {message}");
    ...
    {
        Svc.Log.Error($"{ApsgConstants.LogPrefix} {message}");
    ...
    {
        Svc.Log.Error(exception, $"{ApsgConstants.LogPrefix} {message}");
